...
parser.add_argument('--save', type=str, default='./model/model-electricity-3-Ablation-nontimefusion.pt',
...
parser.add_argument('--subgraph_size',type=int,default=20,help='k') # k=20
parser.add_argument('--node_dim',type=int,default=40,help='dim of nodes')
parser.add_argument('--dilation_exponential',type=int,default=2,help='dilation exponential')

parser.add_argument('--conv_channels',type=int,default=16,help='convolution channels')
parser.add_argument('--residual_channels',type=int,default=64,help='residual channels')     #residual_channels=16
...
parser.add_argument('--timefusion_true', type=int, default=1, help='whether to add time feature fusion')
parser.add_argument('--attention_ture', type=str, default='DAU', help='DAU CAU SAU NAU')
parser.add_argument('--gcn_true', type=int, default=1, help='whether to add graph convolution layer')
...
def main():
    ...
    pprint('Total Train time | %0.2fs' % (totaltime) + '\n')
